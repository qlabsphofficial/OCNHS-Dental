...
<template>
      <div class="flex flex-col lg:flex-row w-full h-full lg:h-10/12 lg:w-11/12 gap-5 p-10 lg:border-2 rounded-md">
            <div class="flex flex-col justify-items items-center lg:items-start gap-3 w-full lg:w-4/12">
                  ...
                  <div class="flex flex-col gap-7 h-full w-full overflow-y-scroll p-5">
                        <div v-for="appointment of appointments" :key="appointment" class="flex flex-col lg:border-2 rounded-md p-10 text-white bg-blue-400">
            ...
            <div class="flex flex-col gap-3 items-center justify-center lg:items-start lg:justify-start w-full lg:w-1/2">
                  ...
                  <div v-for="appointmentRecord of appointments" :key="appointmentRecord" class="flex flex-col lg:border-2 rounded-md p-10 w-full text-white bg-blue-400">
