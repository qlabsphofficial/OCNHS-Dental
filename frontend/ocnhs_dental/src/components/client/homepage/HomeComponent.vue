...
<template>
<!-- Hero -->
<div class="flex flex-row justify-evenly items-evenly h-full w-full">
  <img src="@/assets/Clinic Assets/Dental Clinic images/image/homebg.png" height="100%" width="100%">

  <div class="flex flex-col justify-center items-center w-8/12 hero-negative-marg">
    <h1 class="text-green-800 text-8xl font-bold chewy">SMILE, LEARN, AND GROW</h1>
...
<div class="w-full h-full p-20 overlay-color">
  <h2 class="text-5xl mb-60 font-bold">DENTAL STAFF</h2>
  ...
  <div class="flex flex-row justify-evenly w-full">
    ...
    <div class="w-full p-20">
      ...
      <div class="flex flex-row justify-center w-full gap-3 mt-20">
        ...
        <div class="flex flex-col gap-4 justify-center items-center w-3/12 p-3 border-1 rounded-md mt-">
    ...
    <h2 class="text-5xl font-bold">APPOINTMENTS SCHEDULE</h2>
